...
{
    [Serializable]
    [AddRandomizerMenu("RedBall/Distractor Object Placement Randomizer")]
    public class DistractorObjectPlacementRandomizer : Randomizer
    {
                /// <summary>
        ...
        /// </summary>
        [Tooltip("The width and height of the area in which objects will be placed.")]
        ...
        protected override void OnIterationStart()
        {
            for (var i = 0; i < layerCount; i++)
            {
                ...
                foreach (var sample in placementSamples)
                {
                    ...
                    var instance = Object.Instantiate(prefabs.Sample(), m_Container.transform, true);
